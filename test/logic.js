...
const namespace = 'org.vehiclerental'
...
describe('#' + namespace, () => {
  ...
  beforeEach(async () => {
    ...
    const alice = factory.newResource(
      namespace,
      participantType,
      'alice@email.com'
    )
    ...
    asset1.owner = factory.newRelationship(
      namespace,
      participantType,
      'alice@email.com'
    )
    ...
    asset2.owner = factory.newRelationship(
      namespace,
      participantType,
      'bob@email.com'
    )
  ...
  it('Alice can read all of the assets', async () => {
    ...
    asset1.owner
      ...
      .should.equal(participantNS + '#alice@email.com')
    asset1.value.should.equal('10')
    const asset2 = assets[1]
    asset2.owner
      .getFullyQualifiedIdentifier()
      .should.equal(participantNS + '#bob@email.com')
  ...
  it('Alice can add assets that she owns', async () => {
    ...
    asset3.owner = factory.newRelationship(
      namespace,
      participantType,
      'alice@email.com'
    )
  ...
  it('Bob can add assets that he owns', async () => {
    ...
    asset4.owner = factory.newRelationship(
      namespace,
      participantType,
      'bob@email.com'
    )
