...
async function onRental(rental) {
  ...
  rental.rentalAgreement.vehicle.renterId =
    rental.rentalAgreement.renter.RenterIdentityCardNumber
...
async function onPayment(payment) {
  ...
  payment.rentalAgreement.vehicle.timeBegin = 'Thu Jan 01 1970 08:00:01 GMT+0800 (Indochina Time)'
  const _vehicle = await getAssetRegistry('org.vehiclerental.Vehicle')
