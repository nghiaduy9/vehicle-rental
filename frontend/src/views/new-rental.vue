    ...
    <div class="container w-50" v-if="cookieCheck">
        ...
        <form @submit.prevent="newRental">
            <div class="form-group">
                <input class="form-control" placeholder="Rental id" type="number" required v-model="rentalId">
            </div>
            <div class="form-group">
                <input class="form-control" placeholder="Owner id" type="number" readonly v-model="ownerId">
            </div>
            <div class="form-group">
                <input class="form-control" placeholder="Renter id" type="number" required v-model="renterId">
            </div>
            <div class="form-group">
                <input class="form-control" placeholder="Vehicle id" type="number" required v-model="vehicleId">
            </div>
            <div class="form-group">
                <input class="form-control" placeholder="Price per day" type="number" required v-model="pricePerDay">
            </div>
            <div class="form-group">
                <input class="form-control" placeholder="Deposit" type="number" required v-model="deposit">
            </div>
            <div class="form-group">
                <input class="form-control" placeholder="Time begin" type="date" required v-model="timeBegin">
            </div>
...
<script>
  ...
  async function getRealDetail(ownerId,renterId,vehicleId) {
    ...
    let p1 = await axios.get('http://localhost:3000/api/VehicleOwner/'+ownerId)
    ...
    let p2 =  await axios.get('http://localhost:3000/api/Renter/'+renterId)
    ...
    let p3 = await axios.get('http://localhost:3000/api/Vehicle/'+vehicleId)
  ...
  export default {
    ...
    methods: {
      newRental: async function () {
        ...
        if (detail) {
          axios.post('http://localhost:3000/api/RentalAgreement',{
            ...
            .then(function (res) {
              ...
              axios.post('http://localhost:3000/api/Rental',{
